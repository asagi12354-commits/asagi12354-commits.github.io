...
export const siteConfig: SiteConfig = {
	...
	// 站点副标题
	subtitle: "记录代码、二次元与生活里的碎碎念",

	// 站点 URL
	site_url: "https://asagi12354-commits.github.io",

	// 站点描述
	description:
		"ASAGI 的个人博客，分享技术折腾笔记、ACGN 兴趣与日常碎碎念。愿这里的每一篇文字，都像萤火一样，在长夜里为你亮起一点微光。",

	// 站点关键词
	keywords: ["ASAGI", "个人博客", "技术博客", "ACGN", "二次元", "碎碎念"],

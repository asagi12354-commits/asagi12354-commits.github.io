...
export const zh_CN: Translation = {
	...
	[Key.ojSubmitted]: "已提交",
	[Key.ojRanking]: "排名",
	[Key.ojPageTitle]: "算法刷题",
	[Key.ojPageDescription]: "记录并分析我在各大 OJ 平台的算法刷题情况",
	[Key.ojDifficultyDistribution]: "难度分布",
	[Key.ojPlatformComparison]: "平台对比",
	[Key.ojGrowthTrend]: "刷题增长趋势",
	[Key.ojHeatmap]: "刷题热力图",
	[Key.ojNoData]: "暂无数据",
	[Key.ojLastUpdated]: "数据更新于",
	...
	// 画廊页面
	[Key.gallery]: "画廊",
	[Key.galleryDescription]: "展示我的插画作品",
	[Key.galleryPhotos]: "张作品",
	[Key.galleryAlbums]: "个作品集",
	[Key.galleryNoAlbums]: "暂无作品",
	[Key.galleryBackToAlbums]: "返回作品集列表",

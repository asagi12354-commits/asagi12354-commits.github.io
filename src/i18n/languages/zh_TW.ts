...
export const zh_TW: Translation = {
	...
	[Key.ojSubmitted]: "已提交",
	[Key.ojRanking]: "排名",
	[Key.ojPageTitle]: "演算法刷題",
	[Key.ojPageDescription]: "記錄並分析我在各大 OJ 平台的演算法刷題情況",
	[Key.ojDifficultyDistribution]: "難度分佈",
	[Key.ojPlatformComparison]: "平台對比",
	[Key.ojGrowthTrend]: "刷題增長趨勢",
	[Key.ojHeatmap]: "刷題熱力圖",
	[Key.ojNoData]: "暫無資料",
	[Key.ojLastUpdated]: "資料更新於",
